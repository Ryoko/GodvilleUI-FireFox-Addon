function godvilleui_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
godvilleui_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				godvilleui_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
godvilleui_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
godvilleui_xmlhttpRequester.prototype.setupRequestEvent =
